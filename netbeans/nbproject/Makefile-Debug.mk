...
${OBJECTDIR}/_ext/1522578363/evolution_network_factory.o: ../factory/evolution_network_factory.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1522578363/evolution_network_factory.o ../factory/evolution_network_factory.cpp
...
${OBJECTDIR}/_ext/824854343/evolution_network_function.o: ../function/evolution_network_function.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/824854343/evolution_network_function.o ../function/evolution_network_function.cpp
...
${OBJECTDIR}/_ext/1545248249/evolution_network_protocol.o: ../protocol/evolution_network_protocol.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1545248249/evolution_network_protocol.o ../protocol/evolution_network_protocol.cpp

${OBJECTDIR}/_ext/812711262/evolution_network_socket.o: ../socket/evolution_network_socket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/812711262
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/812711262/evolution_network_socket.o ../socket/evolution_network_socket.cpp

${OBJECTDIR}/_ext/812711262/evolution_network_tcp_bindsocket.o: ../socket/evolution_network_tcp_bindsocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/812711262
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/812711262/evolution_network_tcp_bindsocket.o ../socket/evolution_network_tcp_bindsocket.cpp

${OBJECTDIR}/_ext/812711262/evolution_network_tpc_connectsocket.o: ../socket/evolution_network_tpc_connectsocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/812711262
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/812711262/evolution_network_tpc_connectsocket.o ../socket/evolution_network_tpc_connectsocket.cpp

${OBJECTDIR}/_ext/812711262/evolution_network_udp_bindsocket.o: ../socket/evolution_network_udp_bindsocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/812711262
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/812711262/evolution_network_udp_bindsocket.o ../socket/evolution_network_udp_bindsocket.cpp

${OBJECTDIR}/_ext/812711262/evolution_network_udp_transceiversocket.o: ../socket/evolution_network_udp_transceiversocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/812711262
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX=1 -D_X64=1 -Dnullptr=0 -I../.. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/812711262/evolution_network_udp_transceiversocket.o ../socket/evolution_network_udp_transceiversocket.cpp
